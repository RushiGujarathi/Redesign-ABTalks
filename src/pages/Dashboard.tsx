  ...
  const renderHeatmapSquare = (day: DayProgress | null, index: number) => {
    ...
    return (
      <Link 
        ...
        className={cn(
          "w-3 h-3 rounded-sm border transition-all cursor-pointer hover:scale-125 hover:z-10",
          bgClass,
    ...
    <div className="flex-1 flex flex-col bg-background pb-10 min-h-screen text-gray-100 selection:bg-primary/30 relative">
        ...
        {user.isFirstTime ? (
          ...
          <div className="glass-dark rounded-3xl p-6 border border-red-500/30 relative overflow-hidden shadow-[0_0_30px_rgba(239,68,68,0.15)]">
            ...
            {freezes > 0 ? (
              <div className="flex gap-3 relative z-10">
                <button onClick={handleUseFreeze} className="flex-1 bg-gradient-to-r from-blue-600 to-primary hover:from-blue-500 hover:to-blue-400 text-white font-bold py-3 px-4 rounded-xl text-sm flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all min-h-[44px]">
          ...
          <div className="glass-dark rounded-3xl p-6 border border-white/10 relative overflow-hidden group">
            ...
            <div className="w-full bg-white/5 h-2.5 rounded-full overflow-hidden relative z-10 shadow-inner">
              <div className="bg-gradient-to-r from-orange-500 via-amber-400 to-yellow-300 h-full rounded-full transition-all duration-1000 ease-out shadow-[0_0_10px_rgba(245,158,11,0.5)]" style={{ width: `${Math.min((displayStreak/60)*100, 100)}%` }}></div>
            </div>
      ...
      <div className="px-6 -mt-8 relative z-20">
        <Link 
          ...
          className={cn(
            "glass-dark rounded-3xl p-6 flex flex-col transition-all duration-300 group hover:-translate-y-1 shadow-[0_10px_40px_rgba(0,0,0,0.5)]",
      ...
      <div className="px-6 mt-10 relative z-10">
        ...
        <div className="glass-dark rounded-3xl p-6">
          ...
          <div className="mt-6 flex items-center justify-center gap-5 text-xs text-gray-400 font-medium">
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-green-500 shadow-[0_0_5px_rgba(34,197,94,0.5)]"></div> Completed</div>
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-blue-500 shadow-[0_0_5px_rgba(59,130,246,0.5)]"></div> Frozen</div>
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-red-500 shadow-[0_0_5px_rgba(239,68,68,0.5)]"></div> Missed</div>
          </div>
